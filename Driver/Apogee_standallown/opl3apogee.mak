...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\opl3apogee.pdb" /machine:I386 /out:"$(OUTDIR)\opl3apogee.dll" /implib:"$(OUTDIR)\opl3apogee.lib" 
LINK32_OBJS= \
	"$(INTDIR)\al_midi.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\opl3apogee.pdb" /debug /machine:I386 /out:"$(OUTDIR)\opl3apogee.dll" /implib:"$(OUTDIR)\opl3apogee.lib" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\al_midi.obj" \
	"$(INTDIR)\c_interface.obj" \
	"$(INTDIR)\dbopl.obj" \
