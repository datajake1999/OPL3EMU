...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\opl3doom.pdb" /machine:I386 /def:"..\src\winmm_drv.def" /out:"$(OUTDIR)\opl3doom.dll" /implib:"$(OUTDIR)\opl3doom.lib" 
DEF_FILE= \
	"..\src\winmm_drv.def"
LINK32_OBJS= \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\opl3doom.pdb" /debug /machine:I386 /def:"..\src\winmm_drv.def" /out:"$(OUTDIR)\opl3doom.dll" /implib:"$(OUTDIR)\opl3doom.lib" /pdbtype:sept 
DEF_FILE= \
	"..\src\winmm_drv.def"
LINK32_OBJS= \
	"$(INTDIR)\c_interface.obj" \
