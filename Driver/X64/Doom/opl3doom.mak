...
CLEAN :
	...
	-@erase "$(INTDIR)\winmm_drv_doom.obj"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib bufferoverflowU.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\opl3doom.pdb" /machine:IX86 /def:"..\..\src\winmm_drv.def" /out:"$(OUTDIR)\opl3doom.dll" /implib:"$(OUTDIR)\opl3doom.lib" /machine:AMD64 
DEF_FILE= \
	"..\..\src\winmm_drv.def"
LINK32_OBJS= \
	"$(INTDIR)\dbopl.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib bufferoverflowU.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\opl3doom.pdb" /debug /machine:IX86 /def:"..\..\src\winmm_drv.def" /out:"$(OUTDIR)\opl3doom.dll" /implib:"$(OUTDIR)\opl3doom.lib" /pdbtype:sept /machine:AMD64 
DEF_FILE= \
	"..\..\src\winmm_drv.def"
LINK32_OBJS= \
	"$(INTDIR)\dbopl.obj" \
...
"$(INTDIR)\winmm_drv_doom.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
