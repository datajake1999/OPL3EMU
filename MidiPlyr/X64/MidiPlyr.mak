...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib bufferoverflowU.lib winmm.lib comctl32.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\MidiPlyr.pdb" /machine:IX86 /out:"$(OUTDIR)\MidiPlyr.exe" /machine:AMD64 
LINK32_OBJS= \
	"$(INTDIR)\Debug.obj" \
	"$(INTDIR)\MainWND.obj" \
	"$(INTDIR)\MidiPlyr.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib bufferoverflowU.lib winmm.lib comctl32.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\MidiPlyr.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\MidiPlyr.exe" /pdbtype:sept /machine:AMD64 
LINK32_OBJS= \
	"$(INTDIR)\Debug.obj" \
	"$(INTDIR)\MainWND.obj" \
	"$(INTDIR)\MidiPlyr.obj" \
...
"$(INTDIR)\MidiPlyr.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\MidiPlyr.res" /i "\git\OPL3EMU\MidiPlyr\src" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\MidiPlyr.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\MidiPlyr.res" /i "\git\OPL3EMU\MidiPlyr\src" /d "_DEBUG" $(SOURCE)
