...
"$(INTDIR)\OPL3EMU_CFG.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\OPL3EMU_CFG.res" /i "\git\OPL3EMU\OPL3EMU_CFG" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\OPL3EMU_CFG.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\OPL3EMU_CFG.res" /i "\git\OPL3EMU\OPL3EMU_CFG" /d "_DEBUG" $(SOURCE)
