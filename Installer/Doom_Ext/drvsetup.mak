...
CLEAN :
	-@erase "$(INTDIR)\opl3doom_ext_win32drv_setup.obj"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\drvsetup.pdb" /machine:I386 /out:"$(OUTDIR)\drvsetup.exe" 
LINK32_OBJS= \
	"$(INTDIR)\opl3doom_ext_win32drv_setup.obj" \
	"$(INTDIR)\stdafx.obj"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\drvsetup.pdb" /debug /machine:I386 /out:"$(OUTDIR)\drvsetup.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\opl3doom_ext_win32drv_setup.obj" \
	"$(INTDIR)\stdafx.obj"
...
!IF "$(CFG)" == "drvsetup - Win32 Release" || "$(CFG)" == "drvsetup - Win32 Debug"
SOURCE=..\opl3doom_ext_win32drv_setup.cpp

"$(INTDIR)\opl3doom_ext_win32drv_setup.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
