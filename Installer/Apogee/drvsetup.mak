...
CLEAN :
	-@erase "$(INTDIR)\opl3apogee_win32drv_setup.obj"
...
LINK32_OBJS= \
	"$(INTDIR)\opl3apogee_win32drv_setup.obj" \
	"$(INTDIR)\stdafx.obj"
...
!IF "$(CFG)" == "drvsetup - Win32 Release" || "$(CFG)" == "drvsetup - Win32 Debug"
SOURCE=..\opl3apogee_win32drv_setup.cpp

"$(INTDIR)\opl3apogee_win32drv_setup.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
