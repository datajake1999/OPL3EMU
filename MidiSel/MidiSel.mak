...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\MidiSel.pdb" /machine:I386 /out:"$(OUTDIR)\MidiSel.exe" 
LINK32_OBJS= \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\MidiSel.pdb" /debug /machine:I386 /out:"$(OUTDIR)\MidiSel.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\MIDI Selector.obj" \
	"$(INTDIR)\MIDI Selector.res"
